...
DEFAULT_HOSTNAME = environ.get("LIGHTSTEP_METRICS_HOST", environ.get("LIGHTSTEP_HOST", "ingest.lightstep.com"))
DEFAULT_PORT = environ.get("LIGHTSTEP_METRICS_PORT", environ.get("LIGHTSTEP_PORT", "443"))
DEFAULT_SECURE = environ.get("LIGHTSTEP_METRICS_SECURE", environ.get("LIGHTSTEP_SECURE", "1"))
...
class MetricsReporter:
    ...
    def __init__(self, token=TOKEN, host=DEFAULT_HOSTNAME, port=DEFAULT_PORT, secure=DEFAULT_SECURE, path="/metrics"):
        self._host = host
        self._port = port
        self._token = token
        self._secure = secure
